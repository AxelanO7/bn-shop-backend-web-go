...
func Connect() {
	...
	db.AutoMigrate(&model.Supplier{}, &model.Login{}, &model.Stock{}, &model.Order{}, &model.Input{}, &model.Output{}, &model.User{}, &model.DetailInput{}, &model.DetailOrder{}, &model.DetailOutput{})
	DB = Dbinstance{
		Db: db,
	}
}
